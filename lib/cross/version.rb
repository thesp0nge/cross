module Cross
  # Handles cross version number taken from VERSION file. 
  # The way Haml gem handles it's version.rb inspired me for creating this
  # file. 
  class Version

    # Returns a hash representing the version of cross.
    ...
    # If cross is checked out from Git, the `:rev` key will have the revision hash.  
    # 
    # For example:
    #
    #     {
    ...
    #     }
    # 
    # If a prerelease version of cross is being used,
